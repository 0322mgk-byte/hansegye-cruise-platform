...
모든 파일은 알래스카 레퍼런스(`data/products/alaska-emerald-princess/`)를 **실제로 읽어서 복사**한 뒤, 아래에 명시된 필드**만** 교체한다.
...
**레퍼런스:** `data/products/alaska-emerald-princess/hero-data.ts`
...
**작업 방식:** 레퍼런스 파일을 읽고 복사한 뒤, 아래 필드만 교체
**레퍼런스:** `data/products/alaska-emerald-princess/trip-info-data.ts`
...
**레퍼런스:** `data/products/alaska-emerald-princess/intro-data.ts`
...
**레퍼런스:** `data/products/alaska-emerald-princess/features-data.ts` (구조 참고용)
...
**레퍼런스:** `data/products/alaska-emerald-princess/details-data.ts`
...
**레퍼런스:** `data/products/alaska-emerald-princess/schedule-labels-data.ts`
...
**작업 방식:** 레퍼런스 파일을 읽고 복사한 뒤, 아래 필드만 교체
**레퍼런스:** `data/products/alaska-emerald-princess/product-info-data.ts`
...
**레퍼런스:** `data/products/alaska-emerald-princess/pricing-data.ts`
