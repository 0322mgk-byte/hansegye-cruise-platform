  ...
  // ── Day 3 ──
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: "[관광 정보] 콰트로 칸티 (Quattro Canti)",
        shortTitle: "콰트로 칸티",
        images: [
      ...
      },
      {
        ...
        title: "[관광 정보] 마시모 극장 (Teatro Massimo)",
        shortTitle: "마시모 극장",
        images: [
      ...
      },
      {
        ...
        title: "[관광 정보] 팔레르모 대성당 (Cattedrale di Palermo)",
        shortTitle: "팔레르모 대성당",
        images: [
  ...
  // ── Day 4 ──
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: "MSC 씨뷰 전일 해상",
        images: [
          "https://pub-f396f9b021ba403fb605a64e3824e612.r2.dev/products/western-mediterranean-cruise/sectrion6/day4/MSC-Seaview-Interior/seaview_1.webp",
          "https://pub-f396f9b021ba403fb605a64e3824e612.r2.dev/products/western-mediterranean-cruise/sectrion6/day4/MSC-Seaview-Interior/seaview_2.webp",
          "https://pub-f396f9b021ba403fb605a64e3824e612.r2.dev/products/western-mediterranean-cruise/sectrion6/day4/MSC-Seaview-Interior/seaview_3.webp",
        ],
  ...
  // ── Day 5 ──
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: "[관광 정보] 산타 마리아 대성당 (Catedral de Santa María)",
  ...
  // ── Day 6 ──
  {
    ...
    items: [
      ...
      },
      {
        type: "tourist-spot",
        modalId: "casabatllo",
        title: "[관광 정보] 까사 바트요 (Casa Batlló)",
        shortTitle: "까사 바트요",
        images: [
  ...
  // ── Day 7 ──
  {
    ...
    items: [
      ...
      { type: "text", text: "가이드와 미팅 후 마르세유 투어 시작" },
      {
        ...
        title: "[관광 정보] 노트르담 성당 (Notre-Dame de la Garde)",
        shortTitle: "노트르담 성당",
        images: [
      ...
      },
      {
        ...
        title: "[관광 정보] 마조르 대성당 (Cathédrale de la Major)",
        shortTitle: "마조르 성당",
        images: [
  ...
  // ── Day 8 ──
  {
    ...
    items: [
      ...
      },
      {
        type: "tourist-spot",
        modalId: "sanlorenzo",
        title: "[관광 정보] 산 로렌초 대성당 (Cattedrale di San Lorenzo)",
      ...
      },
      {
        ...
        title: "[관광 정보] 팔라초 산 조르조 (Palazzo San Giorgio)",
  ...
  // ── Day 9 ──
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: "[관광 정보] 트레비 분수 (Fontana di Trevi)",
        shortTitle: "트레비 분수",
        images: [
      ...
      },
      {
        ...
        title: "[관광 정보] 스페인 광장 (Piazza di Spagna)",
        shortTitle: "스페인 광장",
        images: [
      ...
      },
      {
        type: "tourist-spot",
        modalId: "romanforum",
        title: "[관광 정보] 포로 로마노 (Foro Romano)",
        shortTitle: "포로 로마노",
        images: [
