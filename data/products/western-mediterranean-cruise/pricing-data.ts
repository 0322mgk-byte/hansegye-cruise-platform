...
export const pricingData: PricingData = {
  labels: {
    ...
    infoModalTitle: "추가 요금 안내",
    columnCategory: "구분",
    columnCount: "인원",
    columnUnitPrice: "1인 요금",
    columnTotalPrice: "합계",
    personUnit: "명",
    reserveButton: "상품 예약하기",
  },
  roomTabs: [
    { key: "inside", label: "인사이드", prices: { adult: "5,500,000", child: "5,500,000", infant: "5,500,000" } },
    { key: "oceanview", label: "오션뷰", prices: { adult: "5,700,000", child: "5,700,000", infant: "5,700,000" } },
    { key: "balcony", label: "발코니", prices: { adult: "6,200,000", child: "6,200,000", infant: "6,200,000" } },
  ],
