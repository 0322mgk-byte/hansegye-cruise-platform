  ...
  // ─── 2일차: 두바이 관광 ───
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: '도넛 모양의 독특한 외관, 두바이 미래 박물관 [외관]',
        shortTitle: '미래 박물관',
        images: ['/shared/placeholder.png'],
      ...
      },
      {
        ...
        title: '세계 최대의 인공 섬, 팜 주메이라 전망대 [내부]',
        shortTitle: '팜 주메이라',
        images: ['/shared/placeholder.png'],
  ...
  // ─── 7일차: 아부다비 관광 ───
  {
    ...
    items: [
      ...
      },
      {
        type: 'tourist-spot',
        modalId: 'grandmosque',
        title: '화려한 이슬람 예술, 셰이크 자이드 그랜드 모스크 [내부]',
        shortTitle: '그랜드 모스크',
        images: ['/shared/placeholder.png'],
