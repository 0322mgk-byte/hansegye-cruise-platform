...
export const scheduleModalsData: ModalData[] = [
...

  {
    ...
    title: '[관광정보] 미래 박물관 (MUSEUM OF THE FUTURE)',
    images: [
  ...
  },
  {
    type: 'tourist-spot',
    id: 'palmjumeirah',
    title: '[관광정보] 팜 주메이라 (PALM JUMEIRAH)',
    images: [
  ...
  },
  {
    type: 'tourist-spot',
    id: 'desertsafari',
    title: '[관광정보] 사막 사파리 (DESERT SAFARI)',
    images: [
      ...
      "https://pub-f396f9b021ba403fb605a64e3824e612.r2.dev/products/arabia-cruise/section6/day2/Desert-Safari/images.webp",
      "https://pub-f396f9b021ba403fb605a64e3824e612.r2.dev/products/arabia-cruise/section6/day2/Desert-Safari/Sand-Boarding.webp",
    ],
    descriptions: [
  ...
  },
  {
    type: 'tourist-spot',
    id: 'dubaiframe',
    title: '[관광정보] 두바이 프레임 (DUBAI FRAME)',
    images: [
  ...
  },
  {
    ...
    title: '[관광정보] 수크 메디나 쥬메이라 (SOUK MADINAT JUMEIRAH)',
    images: [
  ...
  },
  {
    type: 'tourist-spot',
    id: 'burjalarab',
    title: '[관광정보] 버즈 알아랍 (BURJ AL ARAB)',
    images: [
...

  {
    type: 'tourist-spot',
    id: 'louvreabudhabi',
    title: '[관광정보] 루브르 아부다비 (LOUVRE ABU DHABI)',
    images: [
  ...
  },
  {
    ...
    title: '[관광정보] 카스르 알 와탄 (QASR AL WATAN)',
    images: [
  ...
  },
  {
    type: 'tourist-spot',
    id: 'grandmosque',
    title: '[관광정보] 그랜드 모스크 (SHEIKH ZAYED GRAND MOSQUE)',
    images: [
...

  {
    type: 'tourist-spot',
    id: 'dubaipalace',
    title: '[관광정보] 두바이 왕궁 (ZABEEL PALACE)',
    images: [
  ...
  },
  {
    type: 'tourist-spot',
    id: 'palmmonorail',
    title: '[관광정보] 팜 모노레일 (PALM MONORAIL)',
    images: [
  ...
  },
  {
    type: 'tourist-spot',
    id: 'jbrwalk',
    title: '[관광정보] JBR 더 워크 (JBR THE WALK)',
    images: [
...

  {
    ...
    images: [
      ...
      "https://pub-f396f9b021ba403fb605a64e3824e612.r2.dev/products/arabia-cruise/section6/day5/costa-toscana-entertainment-atrium-colosseo-05252.webp",
    ],
    descriptions: [
      '오늘은 종일 해상에서 보내는 날입니다. 코스타 토스카나의 다양한 시설을 마음껏 즐겨보세요.',
      '솔레미오 스파에서 탈라소테라피와 사우나로 여행의 피로를 풀고, 4개의 수영장과 자쿠지에서 일광욕을 즐기며 여유를 만끽하세요. 폴트로나 프라우 아레나 극장에서 화려한 공연을 관람하거나, 유리 바닥 스카이워크에서 발아래 펼쳐진 바다를 감상해 보세요.',
